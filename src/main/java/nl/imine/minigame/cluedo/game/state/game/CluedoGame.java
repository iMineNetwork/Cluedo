...
public class CluedoGame implements CluedoState, TimerHandler{
    ...
    public static final int SETTINGS_ROUND_TIME = 10;
    ...
    public void handleStateChange() {
        ...
        this.timer = CluedoPlugin.getTimerManager().createTimer(CluedoPlugin.getInstance().getName(), SETTINGS_ROUND_TIME, this);
